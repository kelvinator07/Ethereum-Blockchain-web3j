package com.geekykel.ethereum.service;
...
public class BlockchainService {
    ...
    public BlockchainTransaction process(BlockchainTransaction trx) throws IOException {
        ...
        receipt.getTransactionReceipt().ifPresent(transactionReceipt ->
                LOGGER.info("Tx receipt:  {}", transactionReceipt.getCumulativeGasUsed().intValue()));
